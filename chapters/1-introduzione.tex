...
\begin{itemize}
    ...
    \item Capitolo 4: Analisi del modello cinematico e proposta di algoritmi di controllo per la navigazione autonoma.
    \item Capitolo 5: Architettura software implementata per la gestione del veicolo e l'integrazione dei sensori.
    \item Capitolo 6: Futuri test sperimentali e possibili sviluppi del progetto.
\end{itemize}
