        ...
        \begin{column}{0.48\textwidth}
            \begin{itemize}
                \item \textbf{Input di Controllo}: $\mathbf{u}=\begin{bmatrix}
                              \delta_f & \delta_r & \omega_f & \omega_r
                          \end{bmatrix}^\top$,
                \item \textbf{Velocità Angolare Ruote}: $\omega_i$,
                \item \textbf{Angoli di Sterzo}: $\delta_i$,
...
\begin{frame}
    ...
    \begin{align}
        R_f = \sqrt{\left(x_{ICR} - \frac{L}{2}\right)^2 + \left(y_{ICR} - \frac{W}{2}\right)^2}, \qquad
        R_r = \sqrt{\left(x_{ICR} + \frac{L}{2}\right)^2 + \left(y_{ICR} - \frac{W}{2}\right)^2}
    \end{align}
