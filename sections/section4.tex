...
\begin{frame}
    \frametitle{Cinematica Inversa: Biciclo -- Centro Inst. di Rotazione (ICR)}
...
\begin{frame}
    \frametitle{Cinematica Inversa: Biciclo}
...
\begin{frame}
    \frametitle{Cinematica Inversa: Doppia Ruota Sterzante}
    \textbf{Problema}: dato $(\dot{x}_d, \dot{y}_d, \dot{\theta}_d)$, calcolare $(\delta_f, \delta_r, \omega_f, \omega_r)$
