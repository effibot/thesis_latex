...
\begin{frame}{Modelli e Notazione Usata}
    ...
    \begin{itemize}
        ...
        \item \textbf{Doppia Ruota Sterzante (Bisteer)}: proposta basata su vincoli non-olonomi, senza approssimazioni geometriche.
    \end{itemize}
    \begin{columns}
...
\begin{frame}
    \frametitle{Risultati Feedforward: Traiettoria Arc -- Bicilo}
    \begin{figure}
        \centering
...
\begin{frame}
    \frametitle{Risultati Feedforward: Traiettoria Arc -- Bisteer}
    \begin{figure}
        \centering
...
\begin{frame}
    \frametitle{Risultati PID+FF: Traiettoria Arc -- Bisteer}
    \begin{figure}
        \centering
...
\begin{frame}
    ...
    \textbf{Scelta finale}: \textcolor{green!60!black}{\textbf{Modello Bisteer}} per maggiore versatilità.
\end{frame}
