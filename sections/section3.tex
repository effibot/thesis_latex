...
\begin{frame}
    ...
    \begin{columns}
        ...
        \begin{column}{0.48\textwidth}
            \centering
            \includegraphics[width=0.8\textwidth]{img/daikin/35-A-CO1005.jpeg}
        \end{column}
    \end{columns}
...
\begin{frame}
    ...
    \begin{columns}
        ...
        \begin{block}{Verifica Coppia}
            ...
            \textbf{Piano:}
            $$\tau_{req} = \frac{F_{tot} \cdot r}{2} = \frac{627 \cdot 0.099}{2} \approx 31 \text{ Nm}$$
            $$\tau_{disp} = 2 \times 37 = 74 \text{ Nm} \Rightarrow \textbf{Margine 18\%}$$

            \textbf{Salita 10\%:}
            $$\tau_{req} = \frac{1600 \cdot 0.099}{2} \approx 79 \text{ Nm}$$
            $$\tau_{picco} = 2 \times 180 = 360 \text{ Nm} \Rightarrow \textbf{OK}$$
        \end{block}
    \end{columns}
\end{frame}
\begin{frame}
...
\begin{frame}
    ...
    \begin{columns}
        ...
        \begin{itemize}
            ...
            \item Verifica deformazioni sotto carico
        \end{itemize}
