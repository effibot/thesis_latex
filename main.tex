...
\usepackage{threeparttable} % Table with notes (\begin{tablenotes})
\usepackage{caption}        % Caption formatting
\usepackage{pifont}         % Dingbats for \checkmark and \texttimes symbols
...
%% Configurazione etichette italiane per cleveref
...
\input{2-robot-mobili}
\input{3-requirements}
\input{4-modello-cinematico}
\input{5-software-comunicazione}
\input{6-conclusioni}
