...
\begin{frame}
    ...
    \begin{block}{Perché FAST-LIO 2?}
        Algoritmo LiDAR-Inertial Odometry (LIO) allo stato dell'arte\footnote{Xu et al. "FAST-LIO2: Fast Direct LiDAR-Inertial Odometry", 2022;}.
        \begin{itemize}
...
\begin{frame}
    ...
    \begin{block}{Caratteristiche Principali}
        \begin{itemize}
            ...
            \item \textbf{Arbitraggio Non-Distruttivo}: Priorità basata su ID messaggio.
...
\begin{frame}
    ...
    \begin{columns}
        ...
        \column{0.4\textwidth}
        \begin{block}{Estensione: Profilo CiA 402}
            \begin{itemize}
