...
\begin{frame}
    ...
    \begin{block}{Vantaggi}
        \begin{itemize}
            \item Testato in letteratura\footnote{Tourajizadeh et al., ``Modeling and Optimal Control of 4 Wheel Steering Vehicle Using LQR'', 2020; De Luca et al., ``Feedback Control of a Nonholonomic Car-like Robot'', 1998}.
