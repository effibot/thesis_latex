...
\begin{note}
    Il progetto è stato realizzato mantenendo i costi di realizzazione del veicolo il più bassi possibile, in modo da rendere il prototipo un \textit{dimostratore tecnologico} economico per le potenzialità della tecnologia e valutarne l'effettiva applicabilità in un contesto industriale reale.
\end{note}
...
\begin{itemize}
    ...
    \item Capitolo 3: Analisi dei requisiti e specifiche del veicolo autonomo progettato per l'ambiente industriale considerato. Selezione componenti hardware. Analisi dei costi.
    \item Capitolo 4: Analisi del modello cinematico e proposta di algoritmi di controllo per la navigazione.
    \item Capitolo 5: Architettura software implementata per la gestione del veicolo e l'integrazione dei sensori.
    \item Capitolo 6: Possibili sviluppi futuri del progetto.
\end{itemize}
