...
\begin{frame}{Notazione Usata}
    Proposti due modelli cinematici:
    \begin{itemize}
        \item \textbf{Biciclo Sterzante}: Preso da \cite{tourajizadeh2020fourwheel}
    \end{itemize}
    \begin{columns}
        \begin{column}{0.48\textwidth}
            \begin{itemize}
                ...
                \begin{equation*}
                    p_f^b=\begin{bmatrix}
                        L/2&W/2
                    \end{bmatrix}^\top \quad p_r^b=-\begin{bmatrix}
                        L/2&W/2
                    \end{bmatrix}^\top
                \end{equation*}
            \end{itemize}
...
\begin{frame}
    ...
    \begin{block}{Vantaggi}
        \begin{itemize}
            \item Testato in letteratura\footnote{Tourajizadeh et al., ``Modeling and Optimal Control of 4 Wheel Steering Vehicle Using LQR'', 2020;}.
...
\begin{frame}
    \frametitle{Risultati PID+FF: Traiettoria Arc -- Modello Biciclo}
    \begin{figure}
        \centering
...
\begin{frame}
    \frametitle{Risultati PID+FF: Traiettoria Arc -- Modello Doppio Sterzo}
    \begin{figure}
        \centering
